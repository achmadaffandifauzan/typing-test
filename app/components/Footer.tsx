...
const Footer = () => {
  return (
    <div className="w-full min-h-max sm:py-1.5 py-8 bg-indigo-50 dark:bg-neutral-900 flex sm:flex-row flex-col gap-3 flex-wrap items-center sm:justify-between  sm:px-10 text-sm">
      <div>
        <div>&copy; Achmad Affandi Fauzan 2023</div>
        <div></div>
      </div>
      <a
        className="flex flex-row flex-wrap items-center gap-2 rounded-md  bg-indigo-200 dark:bg-stone-800 hover:bg-indigo-300 dark:hover:bg-amber-500 active:bg-indigo-300 dark:active:bg-amber-400 focus:outline-none focus:ring focus:ring-indigo-400 dark:focus:ring-indigo-600 py-2 px-2"
      ...
      <div className="flex flex-row flex-wrap justify-center items-center bg-indigo-200 dark:bg-stone-800 rounded-md py-1.5 ps-3 pe-2">
